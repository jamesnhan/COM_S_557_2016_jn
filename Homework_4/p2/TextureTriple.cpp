...
#ifdef WIN32
string  GLTripleTexture::_glsl_names[4] = { "tex1", "tex2", "tex3", "texture_blend"};
#endif

GLTripleTexture::GLTripleTexture()
{
 ...
 */
int GLTripleTexture::loadAndCreateTextures(string path_and_file_texture_1, string path_and_file_texture_2, string path_and_file_texture_3)
{
 ...
 */
bool GLTripleTexture::setTextureBlendMode(int mode)
{
 ...
 */
//virtual
bool GLTripleTexture::addVariablesToProgram(GLuint program, int variable_index)
{
 ...
 */
//virtual
bool GLTripleTexture::dirty(GLuint program)
{
    // enable the program
    glUseProgram(program);
